...
from ..models.foundation.model_connection_metadata import ModelConnectionMetadata
...
class LockRequest:
    ...
    metadata: ModelConnectionMetadata = field(default_factory=ModelConnectionMetadata)
...
class AsyncConnectionPool:
    ...
    def __init__(
        ...
        self._active: Dict[str, ModelConnectionMetadata] = {}
    ...
    async def acquire(
        ...
        async with correlation_context(correlation_id=correlation_id):
            async with trace_operation(
                ...
                try:
                    # Use iterative retry loop instead of recursion to prevent overflow
                        ...
                        try:
                            ...
                            if not self._validate_connection(connection):
                                ...
                                if current_retry >= max_retries:
                                    ...
                                    msg = f"Connection failed after {max_retries} tries"
                    ...
                    if connection:
                        try:
                            # Shield cleanup to ensure it completes even if cancelled
