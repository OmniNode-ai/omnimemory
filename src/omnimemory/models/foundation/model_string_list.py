"""
Strongly typed string list model for ONEX Foundation Architecture.

Provides strongly typed list of strings to replace List[str] with validation and deduplication.
"""
