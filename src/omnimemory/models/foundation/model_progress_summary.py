...
from ...enums import MigrationStatus, PriorityLevel
...
class ModelProgressSummaryResponse(BaseModel):
    ...
    priority: PriorityLevel = Field(description="Migration priority level")
    ...
    performance_metrics: dict = Field(
        default_factory=dict, description="Performance metrics for the migration"
    )
